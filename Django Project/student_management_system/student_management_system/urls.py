...
urlpatterns = [
    ...
    path('delete_staff/<str:staff_id>',HodViews.delete_staff),
    path('delete_student/<str:student_id>',HodViews.delete_student),
    path('delete_course/<str:course_id>',HodViews.delete_course),
    path('delete_subject/<str:subject_id>',HodViews.delete_subject),
